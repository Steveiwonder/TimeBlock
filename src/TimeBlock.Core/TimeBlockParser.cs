...
namespace TimeBlock.Core
{
    ...
    internal class TimeBlockParser
    {
        ...
        private TimeBlockParser()
        {

        }

        public static TimeBlock Parse(string spec)
        {
            ...
            var parser = new TimeBlockParser();
            ...
            return new TimeBlock(seconds, minutes, hours, days, months, years);
        }

        public static bool TryParse(string spec, out TimeBlock timeBlock)
        {
            try
            {
